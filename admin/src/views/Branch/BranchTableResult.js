...
function BranchTableResult(props) {
                ...
                <CRow md="12">
                    <CRow className='col-md-6 mb-2'>
                        <CCol md="3" className='d-flex align-items-center'>
                            <CFormLabel className="mt-2">Mã hãng</CFormLabel>
                        </CCol>
                        <CCol md="7">
                    ...
                    <CRow className='col-md-6 mb-2'>
                        <CCol md="3" className='d-flex align-items-center'>
                            <CFormLabel className="mt-2">Tên hãng</CFormLabel>
                        </CCol>
                        <CCol md="7">
                    ...
                    <CRow className='col-md-6 mb-2'>
                        <CCol md="3" className='d-flex align-items-center'>
                            <CFormLabel className="mt-2">Xuất xứ</CFormLabel>
                        </CCol>
                        <CCol md="7">
...
export default BranchTableResult
