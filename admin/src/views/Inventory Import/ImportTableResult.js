...
function ImportTableResult(props) {
        ...
        <div className='container mt-5 bg-container position-relative '>
            <CForm className='mb-4 '> 
                ...
                <CRow md="12">
                    ...
                    <CRow className='col-md-6 mb-2'>
                        <CCol md="3" className='d-flex align-items-center'>
                            <CFormLabel className="mt-2">Đối tác</CFormLabel>
                        </CCol>
                        <CCol md="7">
                    ...
                    <CRow className='col-md-6 mb-2'>
                        <CCol md="3" className='d-flex align-items-center'>
                            <CFormLabel className="mt-2">Tổng phiếu</CFormLabel>
                        </CCol>
                        <CCol md="7">
                        <CFormInput name='roleName' onChange={(e)=>handleFilter(e)}/>
                        </CCol>
...
export default ImportTableResult
